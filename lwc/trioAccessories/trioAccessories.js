...
export default class TrioAccessories extends LightningElement {
    ...
    async fetchMetadata() {
        ...
        try {
            ...
            if (
                ...
                this.selections.ACCESSORIES.length
            ) {
    ...
    handleAccessorySelect(event) {
        ...
        // Remove None if another option selected
        this.selectedAccessories =
