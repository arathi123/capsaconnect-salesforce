...
export default class CapsaNonPoweredLX5Accessories extends LightningElement {
    ...
    connectedCallback() {
        getOptionsByStepAndFamily({ stepKey: 'Accessories', productFamily: this.productType || 'NonPoweredLX5' })
            .then(data => {
    ...
    handleNext() {
        ...
        this.dispatchEvent(new CustomEvent('stepcomplete', {
            detail: { ACCESSORIES: { accessories, accessoryNone: this.accessoryNone } }
        }));
    }
}