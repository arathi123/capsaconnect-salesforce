...
export default class CapsaRobotsWarranty extends LightningElement {
    ...
    connectedCallback() {
        getOptionsByStepAndFamily({ stepKey: 'WARRANTY', productFamily: this.productType || 'Robots' })
            .then(data => {
