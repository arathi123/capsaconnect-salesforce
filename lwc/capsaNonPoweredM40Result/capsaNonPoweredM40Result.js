...
export default class CapsaNonPoweredM40Result extends NavigationMixin(LightningElement) {
    @api opportunityId;
    @api summaryData = {};
    @api quoteId;
    @track isLoading = false;

    get hasCartTypeComputing() { return (this.summaryData.cartTypeComputing || []).length > 0; }
    get hasPowerCordOption()   { return (this.summaryData.powerCordOption || []).length > 0; }
    ...
    generateProductData() {
        ...
        addItems(this.summaryData.cartTypeComputing);
        addItems(this.summaryData.powerCordOption);
