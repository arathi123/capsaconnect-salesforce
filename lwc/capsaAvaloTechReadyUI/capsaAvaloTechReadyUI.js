...
export default class CapsaAvaloTechReadyUI extends LightningElement {
    @api opportunityId;
    productType = 'Avalo Tech Ready';
    ...
    handlePathSelection(event) {
        ...
        if (target === 'TypeSelection') {
            ...
            const engine = this.template.querySelector('c-capsa-avalo-tech-ready-build');
            if (engine) {
