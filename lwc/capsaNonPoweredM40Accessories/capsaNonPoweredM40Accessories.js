...
export default class CapsaNonPoweredM40Accessories extends LightningElement {
    ...
    connectedCallback() {
        getOptionsFresh({ stepKey: 'Accessories', productFamily: this.productType || 'NonPoweredM40' })
            .then(data => {
