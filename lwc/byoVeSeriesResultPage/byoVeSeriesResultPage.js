...
export default class ByoVeSeriesResultPage extends NavigationMixin(LightningElement) {
    ...
    get hasExtendedStorage() {

        return this.selections.extendedStorage
            && Object.keys(this.selections.extendedStorage).length > 0;
    }

    get hasExtraStorageType() {

        return this.selections.extraStorageType
            && Object.keys(this.selections.extraStorageType).length > 0;
    }
    ...
    get extendedStorageCode() {

        return this.selections.extendedStorage?.configCode
            || this.selections.extendedStorage?.key
            || '';
    }
    ...
    generateProductData() {
        ...
        if (
            ...
            processItems(
                `U${this.selections.extendedStorage.configCode}`,
                1,
                ''
            );
        }
