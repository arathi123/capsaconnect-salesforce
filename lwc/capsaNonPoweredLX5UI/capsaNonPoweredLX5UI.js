...
export default class CapsaNonPoweredLX5UI extends LightningElement {

    @api opportunityId;
    productType = 'NonPoweredLX5';
    ...
    handlePathSelection(event) {
        ...
        if (target === 'TypeSelection') {
            ...
            const engine = this.template.querySelector('c-capsa-non-powered-l-x5-build');
            if (engine) {
