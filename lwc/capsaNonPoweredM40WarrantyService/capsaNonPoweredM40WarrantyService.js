...
export default class CapsaNonPoweredM40WarrantyService extends LightningElement {
    ...
    connectedCallback() {
        getOptionsFresh({ stepKey: 'WarrantyService', productFamily: this.productType || 'NonPoweredM40' })
            .then(data => {
